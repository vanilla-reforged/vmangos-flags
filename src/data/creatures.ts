...
export const creatureImmunities = [
  ...
  { name: 'poly/disorient/confuse', bitIndex: 2, decimal: '4', hex: '0x4' },
  { name: 'interrupt', bitIndex: 3, decimal: '8', hex: '0x8' },
  { name: 'transform ?', bitIndex: 4, decimal: '16', hex: '0x10' },
  { name: 'knockout(incapacitates)', bitIndex: 5, decimal: '32', hex: '0x20' },
  { name: 'slow/snare', bitIndex: 6, decimal: '64', hex: '0x40' },
  { name: 'charm/possess?90%', bitIndex: 7, decimal: '128', hex: '0x80' },
